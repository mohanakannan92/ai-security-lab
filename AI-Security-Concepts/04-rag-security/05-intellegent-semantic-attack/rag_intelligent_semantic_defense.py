# rag_intelligent_semantic_defense.py
...
# -------------------------------
# 🧠 Intelligent Semantic Risk Classifier (UPDATED 🔥)
# -------------------------------
def classify_query_risk(query):
    query = query.lower()

    # 🔴 HIGH RISK (direct extraction attempts)
    high_risk = [
        "reveal system",
    ...
    # 🟡 MEDIUM RISK (semantic intent variations)
    medium_risk = [
        "how do you work",
        "how you work",
        "how do you ensure",
...
def run_rag(query):
    ...
    # 🟡 MEDIUM RISK → SAFE GENERIC RESPONSE
    if risk == "MEDIUM":
        return (
...
# -------------------------------
# ▶️ Optional direct run (debug)
# -------------------------------
if __name__ == "__main__":
    test_query = "What rules guide your responses?"
    print("\n===== OUTPUT =====\n")
    print(run_rag(test_query))